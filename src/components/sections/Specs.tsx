    ...
    <section className="bg-chalk py-24 md:py-36">
      <div className="max-w-[1200px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-start">
            ...
            <div className="mt-8 border border-black/10 p-4">
              <div className="flex flex-wrap gap-2">
                {["IEC 60529", "EN 62493", "CE", "RoHS"].map((cert) => (
                  <span
                    key={cert}
                    className="font-tech text-[10px] tracking-wider text-mist border border-black/10 px-2 py-1"
                  >
                    {cert}
                  </span>
                ))}
          ...
          <div ref={ref} className="lg:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-0 border border-black/10">
            {PRODUCT_SPECS.map((spec, i) => (
              <motion.div
                ...
                className="p-5 md:p-6 border-b border-r border-black/10 relative group"
              >
                {/* Amber bottom accent */}
                ...
                <p className="font-tech text-dirt text-xl md:text-2xl font-medium leading-none">
                  {spec.value}
                </p>
              </motion.div>
            ))}
