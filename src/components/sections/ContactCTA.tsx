...
export default function ContactCTA() {
  return (
    <section className="skew-top-sm bg-chalk py-28 md:py-40 mt-[-2vw]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <Link
                href="/kontakt"
                className="inline-flex items-center bg-brand text-dirt font-body font-semibold text-sm uppercase tracking-wider px-8 py-4 hover:bg-[#9D8B36] transition-colors self-start"
              >
                Poptávka zdarma
              </Link>
              <a
                href={`tel:${COMPANY.phone.replace(/\s/g, "")}`}
                className="text-mist hover:text-dirt transition-colors text-sm font-tech tracking-wide"
              >
